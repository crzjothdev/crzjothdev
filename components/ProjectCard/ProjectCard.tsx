...
export default function ProjectCard({ thumbnail, gitHubUrl, title, subtitle }: Props) {
  return (
    <div className="rounded-lg shadow-md overflow-hidden bg-white dark:bg-gray-800">
      <a href={gitHubUrl} target="_blank" rel="noreferrer" aria-label="GitHub Repository">
        <div className="relative aspect-square">
          ...
          <div className="absolute top-2 right-0 bg-white dark:bg-gray-700 p-1 pl-1.5 rounded-l-2xl z-10">
      ...
      <div className="p-3">
        ...
        <span className="text-xs tracking-wide text-gray-500 dark:text-gray-400">{subtitle}</span>
      </div>
    </div>
  )
}
